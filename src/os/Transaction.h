...
namespace ceph::os
{
    ...
    public:
        enum
        {
            ...
            OP_SPLIT_COLLECTION2 = 36, /* cid, bits, destination doesn't create the destination */
        ...
        struct TransactionData
        {
            ...
            TransactionData() noexcept : ops(init_le64(0)),
            ...
            TransactionData(TransactionData &&other) noexcept : ops(other.ops),
    ...
    public:
        ...
        // override default move operations to reset default values
        Transaction(Transaction &&other) noexcept : data(std::move(other.data)),
